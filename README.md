...
Source can be loaded via [npm](https://www.npmjs.com/package/nwc-i18next), bower or [downloaded](https://github.com/i18next/nwc-i18next/blob/master/i18next-jquery.min.js) from this repo.
